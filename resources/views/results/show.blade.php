...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                            ...
                            <td>
                                ...
                                @foreach($result->question->options as $option)
                                    <li style="@if ($option->correct == 1) font-weight: bold; @endif
                                        ...
                                        @if ($option->correct == 1) <em>(Helyes megfejtés)</em> @endif
                                        @if ($result->option_id == $option->id) <em>(A te válaszod)</em> @endif
                                    </li>
                                @endforeach
                                </ul>
                            </td>
            ...
            <a href="{{ route('tests.index') }}" class="btn btn-default">Másik kvíz kitöltése</a>
            <a href="{{ route('results.index') }}" class="btn btn-default">Összes eredményem megketikntése</a>
        </div>
    </div>
@stop
